...
<div id="Test" style="width: 100%; height: 706px; background-color: #fefefe">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <div class="caption">
                            ...
                            <p>The head designer, Corbin has helped to code the website of GamePlan. He didn't make very many important decisions, but designed what others told him to until they decided to change everything. He might as well just quit now.</p>
                        </div>
                    </div>
                </div>
            </div>
